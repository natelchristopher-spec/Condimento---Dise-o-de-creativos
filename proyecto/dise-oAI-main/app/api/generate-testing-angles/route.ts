          ...
          angles.map(async (angle) => {
            ...
            if (isFashionProduct) {
              ...
              fullPrompt = [
                ...
                'REGLA DE LOGO: NO agregues ni generes el nombre de la marca anunciante como logo, wordmark o elemento gráfico superpuesto en el creativo. La identidad de marca se expresa únicamente a través del headline, los colores y el layout indicados. Cualquier branding visible en el producto de la foto de referencia (etiquetas, estampados, logos impresos en la prenda) debe preservarse exactamente como aparece — no lo elimines ni lo modifiques.',
